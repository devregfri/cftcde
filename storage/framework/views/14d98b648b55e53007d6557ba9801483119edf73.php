                                    ...
                                    <li style="margin-bottom: -0.5%">
                                        <div class="navbar-login" style="width: 600px">
                                            <div class="row" style="width: 100%">
                                                <div class="col-xs-3">
                                                    <p class="text-center">
                                                      <img style="margin-left: auto;margin-right: auto;" width="50px" class="img-responsive" alt="Responsive Photo Galeri" src="<?php echo e(URL::to('/private/public/image/logo/voli/ball-voli.png')); ?>"/>
                                                      <p style="text-align: center" class="small">Voli</p>
                                                    </p>
                                                </div>
                                                <div class="col-xs-3">
                                                    <p class="text-center">
                                                      <img style="margin-left: auto;margin-right: auto;" width="50px" class="img-responsive" alt="Responsive Photo Galeri" src="<?php echo e(URL::to('/private/public/image/logo/bola/ball-sepakbola.png')); ?>"/>
                                                      <p style="text-align: center" class="small">Bola</p>
                                                    </p>
                                                </div>
                                                <div class="col-xs-3">
                                                    <p class="text-center">
                                                      <img style="margin-left: auto;margin-right: auto;" width="50px" class="img-responsive" alt="Responsive Photo Galeri" src="<?php echo e(URL::to('/private/public/image/logo/Badminton/ball-badminton.png')); ?>"/>
                                                      <p style="text-align: center" class="small">Badminton</p>
                                                    </p>
                                                </div>
                                                <div class="col-xs-3">
                                                    <p class="text-center">
                                                      <img style="margin-left: auto;margin-right: auto;" width="50px" class="img-responsive" alt="Responsive Photo Galeri" src="<?php echo e(URL::to('/private/public/image/logo/basket/ball-basket.png')); ?>"/>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <?php else: ?>
                            ...
                            <li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                  <li  style="margin-bottom: -1%" class="small">
                                      <a style="color: #909090;" href=""><span>Profil</span><br><b><?php echo e(Auth::user()->name); ?></b></a>
                                  </li>
                                  <li class="divider"></li>
                                  <li style="margin-bottom: -1%" class="small">
                                  ...
                                  <li class="divider"></li>
                                  <li style="margin-bottom: -1%" class="small">
                                        <a style="color: #909090;" href="<?php echo e(route('logout')); ?>"
                      ...
                      <div class="navbar navbar-default" role="navigation">
                        ...
                        <div class="navbar-collapse collapse sidebar-navbar-collapse">
                          <ul class="nav navbar-nav" id="sidenav01">
                            <li style="margin-bottom: -3%" class="small"><a href="<?php echo e(URL::to('/')); ?>" style="color: #909090;" href="">Home</a></li>
                            
                            <?php if(Auth::user()->role_id == 21 || Auth::user()->role_id == 22): ?>
                              ...
                              <li style="margin-bottom: -3%" class="small">
                                  <a style="color: #909090;font-size: 8pt" href="<?php echo e(route('statistikAgen.create')); ?>">Input statistik</a>
                              </li>
                              <li style="margin-bottom: -3%" class="small">
                                  <a style="color: #909090;font-size: 8pt" href="<?php echo e(route('statistikAgen.index')); ?>">View statistik</a>
                              </li>
                            <?php endif; ?>
                            <?php if(Auth::user()->role_id == 6): ?>
                              <li style="margin-bottom: -3%" class="small"><a style="font-size: 7pt"><b>STATISTIK DESAINER</b></a></li>
                              <li style="margin-bottom: -3%" class="small">
                                  <a style="color: #909090;font-size: 8pt" href="<?php echo e(route('statistikDesainer.create')); ?>">Input custom desain</a>
                              </li>
                            <?php endif; ?>
